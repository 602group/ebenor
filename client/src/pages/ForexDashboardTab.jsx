...
export default function ForexDashboardTab() {
  const [data, setData] = useState(null);

  useEffect(() => {
    api.get('/sectors/forex/dashboard').then((r) => setData(r.data));
  }, []);
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        ...
        <div className="card">
          <div className="card-header">
            <div className="card-title">📅 Upcoming Macro Events</div>
          </div>
          <div className="card-body">
        ...
        <div className="card">
          <div className="card-header">
            <div className="card-title">📰 Sector News Feed</div>
          </div>
          <div className="card-body">
            {news.length ? (
              news.map((n) => (
